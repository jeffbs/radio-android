...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigationSafeArgsGradlePlugin</b> with value <b>2.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Group of bundles at <b>bundles.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidBundleAccessors extends BundleFactory {
        private final AndroidRoomBundleAccessors baccForAndroidRoomBundleAccessors = new AndroidRoomBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);
        ...
        /**
         * Group of bundles at <b>bundles.android.room</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidRoomBundleAccessors getRoom() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return baccForAndroidRoomBundleAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidRoomBundleAccessors extends BundleFactory {

        public AndroidRoomBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>android.room.bundle</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getBundle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("android.room.bundle");
        }
